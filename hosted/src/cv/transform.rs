...
impl<
        RhoIter: Iterator<Item = isize> + Clone,
        ThetaIter: Iterator<Item = isize> + Clone,
...
impl<Color: ColorCode<Marker = u8>> Transform<Color> for HoughCircles {
    type Output = Vec<Circle<Color>>;
